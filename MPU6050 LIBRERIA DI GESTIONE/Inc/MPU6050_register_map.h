 ...
 * @author Robert Laurentiu Mincu, Matteo Vitullo
 * @version 1.0
 * @date 22/03/2025
 *****************************************************************************/

/**
 * @brief I registri 13-16 sono utilizzati per i "self-test" dell'accelerometro e del giroscopio, che permettono all'utente di verificare il corretto 
...
/**
 * @brief Il registro è usato per innescare il self test dell'accelerometro e configurare l'intervallo di misurazione. Configura anche il DHPF
 *        - Innesco del self-test : impostare il bit alto causa il self test : bit7, bit6, bit5 ->(XA_ST, YA_ST, ZA_ST)
 *                                     
 ...
 * 
 *        di default il valore del registro è : 0x68
 *        -tipo : R
 *        -i2c_size_byte : 1
 * 
 */
