...
/*
  ...
  */
	 ...
	 if (HAL_I2C_Mem_Write(&hi2c1, address, index, I2C_MEMADD_SIZE_8BIT, pdata, count, HAL_MAX_DELAY) == HAL_OK)
	    {
	        return STATUS_OK;
	    }
	    else
...
{/*
    ...
    return status;
    */
	 if (HAL_I2C_Mem_Read(&hi2c1, address, index, I2C_MEMADD_SIZE_8BIT, pdata, count, HAL_MAX_DELAY) == HAL_OK)
	    {
	        return STATUS_OK;
	    }
	    else
